...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/UseCases/createPlant.jpg}
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/UseCases/listPlants.jpg}
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/UseCases/createThing.jpg}
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/UseCases/viewPlant.jpg}
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/UseCases/configureLights.jpg}
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/UseCases/updatePlant.jpg}
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/UseCases/configurePump.jpg}
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/UseCases/configureFan.jpg}
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/UseCases/deletePlant.jpg}
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/UseCases/UpdateShadow.jpg}
...
\section{Process Specification}
	...
	\subsection{Backend}
		...
		\subsubsection{IoT Manager}
			...
			In order to control the MQTT messages and Internet of Things devices in our system, we are using an IoT manager. The manager authenticates all of the devices (things), controls all of the IoT topics that the things publish to, any rules to be processed on the incoming MQTT messages etc.
