...
\section{Functional Requirements}
	\subsection{Use Case Prioritisation}
		...
		The use cases for each subsystem have been sorted into \emph{Critical} (the system could not work without it), \emph{Important} (the system would work, but would be very different without it) and \emph{Nice-to-have} (not very important; low priority).
